...
<body>
    ...
    <div class="container">
        ...
        ?>
        <a href="https://github.com/Yl1a/js.git" class="link">GitHub</a>
        <div class="regForm">
            ...
            <img src="./img/Madalina Cojocari_ Mysterious Disappearance.jpg" alt="regImg" class="img">
        </div>
    </div>
</body>
...
function checkEmail($email)
{
    ...
    if (empty($email)) {
        ...
        $error = '<p class="error">*слишком длинная почта</p>';
    }
    return $error;
}
